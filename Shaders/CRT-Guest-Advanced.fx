...
float4 ChromaticPS(float4 position:SV_Position,float2 texcoord:TEXCOORD):SV_Target
{
	...
	float mx0=COMPAT_TEXTURE(GUEST_S7,pos1-dx).a;
	float mx2=COMPAT_TEXTURE(GUEST_S7,pos1+dx).a;
	...
	mx0=COMPAT_TEXTURE(GUEST_S7,pos1-dx).a;
	mx2=COMPAT_TEXTURE(GUEST_S7,pos1+dx).a;
